...
model.load_weights('/Users/salemameen/Desktop/banditsbook/python_car/CARModelbest.hdf5')
model.compile(loss='categorical_crossentropy',
              metrics=['accuracy'],
              optimizer='adam')
# Actual modelling

score, accuracy = model.evaluate(X_deploy, labelsDepy, batch_size=6, verbose=0)
